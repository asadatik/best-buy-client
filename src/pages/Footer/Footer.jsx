...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link   text-white link-hover flex gap-1 "><MdEmail  className="text-lg" />   shosort09@gmail.com</a>
...
<footer className="footer  px-10 py-4 border  bg-indigo-500 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>ShopSort  Ltd. <br/>Providing reliable tech since 1992</p> 
  </aside> 
